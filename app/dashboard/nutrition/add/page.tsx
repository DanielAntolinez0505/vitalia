  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description:
          "No se pudo agregar el alimento. Por favor, intenta de nuevo.",
        variant: "destructive",
      });
    }
  };
  ...
  const handleSaveFrequentMeal = () => {
    if (foodName && calories) {
      ...
      toast({
        title: "Error",
        description:
          "Por favor, ingresa al menos el nombre y las calorías de la comida.",
        variant: "destructive",
      });
    }
  };
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <CalorieGoal
        ...
        setCalorieGoal={setDailyCalorieLimit}
      />
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex space-x-2">
              ...
              <Button
                type="button"
                variant="outline"
                onClick={handleSaveFrequentMeal}
              >
