...
const recipes = [
  {
    ...
    instructions:
      "1. Cocina la quinoa según las instrucciones del paquete. 2. Mezcla con los vegetales picados. 3. Aliña con aceite de oliva y jugo de limón.",
  ...
  },
  {
    ...
    instructions:
      "1. Mezcla todos los ingredientes en una licuadora. 2. Licúa hasta obtener una consistencia suave.",
  ...
  },
  {
    ...
    instructions:
      "1. Cocina la avena con leche. 2. Agrega las frutas picadas y las nueces. 3. Endulza con un poco de miel.",
    goal: "mantenimiento",
  },
];
...
export default function RecipesPage() {
  ...
  const handlePreferencesSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description:
        "Tus preferencias alimenticias y alergias han sido registradas.",
    });
          ...
          <div className="mb-4">
            <Select onValueChange={setSelectedGoal} defaultValue={selectedGoal}>
              ...
              <SelectContent>
                ...
                <SelectItem value="ganancia de músculo">
                  Ganancia de músculo
                </SelectItem>
            ...
            {filteredRecipes.map((recipe) => (
              ...
              >
                <Card>
                  ...
                  <CardContent>
                    <p>
                      Calorías: {recipe.calories} | Proteínas: {recipe.protein}g
                      | Carbohidratos: {recipe.carbs}g | Grasas: {recipe.fat}g
                    </p>
